...
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (1,'Kosher',15);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (2,'Regular',4);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (3,'Kosher',2);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (4,'Kosher',11);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (5,'Kosher',13);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (6,'Kosher',2);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (7,'Regular',1);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (8,'Kosher',6);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (9,'Kosher',7);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (10,'Regular',8);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (11,'Regular',14);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (12,'Kosher',13);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (13,'Kosher',12);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (14,'Kosher',6);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (15,'Kosher',13);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (16,'Kosher',4);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (17,'Regular',13);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (18,'Regular',13);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (19,'Kosher',14);
INSERT INTO P_CATALOG (C_ID,CAT,G_ID) VALUES (20,'Organic',7);

INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Watermelon','72.13',100,'vitae, erat. Vivamus nisi. Mauris nulla. Integer urna. Vivamus molestie dapibus ligula. Aliquam erat',11);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Chicken','29.48',13,'non',5);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Nuts','56.25',76,'dui augue eu tellus. Phasellus elit pede, malesuada vel, venenatis vel, faucibus id, libero. Donec consectetuer mauris id sapien.',12);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Pasta','32.92',25,'posuere, enim nisl elementum purus, accumsan interdum libero',19);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Avocado','25.78',55,'molestie tortor nibh',20);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Beef','35.40',17,'orci. Ut sagittis lobortis mauris. Suspendisse aliquet molestie tellus. Aenean egestas hendrerit neque. In',11);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Juice','76.81',35,'dictum.',20);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Pork','60.06',91,'Duis a mi fringilla mi lacinia mattis. Integer eu lacus.',19);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Noodles','29.66',0,'nunc ac mattis ornare, lectus ante dictum mi, ac',19);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Olive Oil','60.62',196,'senectus et netus et malesuada fames ac turpis egestas. Fusce',15);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Cereal','96.78',196,'aliquam, enim nec tempus scelerisque, lorem ipsum sodales purus, in molestie',8);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Rice','92.34',105,'semper et, lacinia vitae,',8);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Onion','10.15',137,'eleifend egestas. Sed pharetra, felis eget varius ultrices, mauris ipsum porta elit, a feugiat tellus lorem eu',5);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Ice Cream','59.99',86,'Donec luctus aliquet odio. Etiam ligula tortor, dictum eu, placerat eget, venenatis a, magna. Lorem ipsum dolor',14);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Candy','93.96',171,'In tincidunt congue turpis. In condimentum. Donec at arcu. Vestibulum ante ipsum primis',16);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Lemon','42.00',186,'Donec vitae erat vel pede blandit congue. In scelerisque scelerisque',9);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Apple','26.00',146,'hendrerit a, arcu. Sed et libero. Proin mi.',17);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Lays','66.33',0,'convallis in, cursus et, eros.',1);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Butter','1.03',151,'nulla magna, malesuada vel, convallis in, cursus et, eros. Proin ultrices. Duis volutpat',19);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Cracker','40.49',17,'Donec egestas. Aliquam nec enim. Nunc ut erat. Sed nunc',15);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Seaweed','93.55',89,'Sed nec metus facilisis lorem tristique aliquet. Phasellus fermentum convallis ligula. Donec luctus aliquet odio. Etiam ligula tortor,',12);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Egg','98.62',132,'semper cursus. Integer mollis. Integer tincidunt aliquam arcu. Aliquam ultrices iaculis odio. Nam interdum enim non nisi. Aenean eget',13);
INSERT INTO PRODUCT (P_NAME,PRICE,QUANTITY,DESCRIPTION,C_ID) VALUES ('Flour','58.49',161,'neque. Morbi quis urna. Nunc quis arcu vel quam dignissim pharetra. Nam ac',10);
